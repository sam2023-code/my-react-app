...
const Vaccine = () => {
    ...
    const data = [
        ...
        { id: 5,id_loc: '4. FHS', vaccine: '肺炎球菌疫苗 第一劑', date: '2024-06-25' },
        { id: 1004,id_loc: '', vaccine: '', date: '' },
        { id: 6,id_loc: '5. TST', vaccine: 'ACT-HIB 第一劑', date: '2024-07-09' },
        { id: 7,id_loc: '5. TST', vaccine: 'ROTATEQ 第一劑', date: '2024-07-09' },
        { id: 1005,id_loc: '', vaccine: '', date: '' },
        { id: 8,id_loc: '6. FHS', vaccine: 'DTaP-IPV 疫苗 第二劑', date: '2024-08-27' },
        { id: 9,id_loc: '6. FHS', vaccine: '肺炎球菌疫苗 第二劑', date: '2024-08-27' },
        { id: 1006,id_loc: '', vaccine: '', date: '' },
        { id: 10,id_loc: '7. TST', vaccine: 'ACT-HIB 第二劑', date: '2024-09-01' },
        { id: 11,id_loc: '7. TST', vaccine: 'ROTATEQ 第二劑', date: '2024-09-01' },
        { id: 1007,id_loc: '', vaccine: '', date: '' },
        { id: 12,id_loc: '8. FHS', vaccine: 'DTaP-IPV 疫苗 第三劑', date: '2024-10-23' },
        { id: 13,id_loc: '8. FHS', vaccine: '乙型肝炎疫苗 第三劑', date: '2024-10-23' },
        { id: 1008,id_loc: '', vaccine: '', date: '' },
        { id: 14,id_loc: '9. FHS', vaccine: '肺炎球菌疫苗 加強劑', date: '2025-04-24' },
        { id: 15,id_loc: '9. FHS', vaccine: '麻疹、流行性腮腺炎及德國麻疹混合疫苗 第一劑', date: '2025-04-24' },
        { id: 16,id_loc: '9. FHS', vaccine: '水痘疫苗 第一劑', date: '2025-04-24' },
        { id: 1009,id_loc: '', vaccine: '', date: '' },
        { id: 17,id_loc: '10. FHS', vaccine: '---  2:15 PM  ---', date: '2025-10-28' },
    ];

  return (
    <>
    <h1 style={{minHeight: '50px'}}> {t('Navbar_vaccine_page_title')} </h1>
